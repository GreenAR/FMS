...
module.exports = "<div class=\"main-content\">\r\n        <div class=\"container-fluid\">\r\n            <div class=\"row\">\r\n                <div class=\"col-md-12\">\r\n                    <div class=\"card\">\r\n                        <div class=\"card-header card-header-text\" data-background-color=\"orange\">\r\n                            <h4 class=\"card-title\">Messanger</h4>\r\n                        </div>\r\n                        \r\n                        <div class=\"card-content\">\r\n                                <div class=\"body1\">\r\n                            <div class=\"container2 clearfix\">\r\n                                <div class=\"people-list\" id=\"people-list\">\r\n                                        <div class=\"search\">\r\n                                          <input #p type=\"text\" placeholder=\"search\" />\r\n                                          <i class=\"fa fa-search\"></i>\r\n                                        </div>\r\n                                        <ul class=\"list style-1\" style=\"\r\n                                        overflow: auto;\r\n                                    \">\r\n                                          <li *ngFor=\"let user of OtherUsers|list2:p.value\" class=\"clearfix\">\r\n                                            <a\r\n                                                (click)=\"selectuser(user)\"\r\n                                            ><img \r\n                                            style=\"width: 55px !important;\r\n                                                   height: 55px !important;\r\n                                                   border-radius: 50%;\"\r\n                                             [src]=\"user.pic!=null?user.pic:'assets/img/placeholder.jpg'\" alt=\"avatar\" /></a>\r\n                                            <div class=\"about\">\r\n                                              <div class=\"name\">{{user.name}}</div>\r\n                                            </div>\r\n                                          </li>  \r\n                                        </ul>\r\n                                      </div>\r\n                                      \r\n                                      <div *ngIf=\"chatWith\" class=\"chat\" style=\"\r\n                                      padding-bottom: 20px;width: 1006px;\">\r\n                                        <div class=\"chat-header clearfix\">\r\n                                          <img [src]=\"chatWith.pic!=null?chatWith.pic:'assets/img/placeholder.jpg'\" alt=\"avatar\"\r\n                                          style=\"width: 55px !important;\r\n                                          height: 55px !important;\r\n                                          border-radius: 50%;\"\r\n                                           />\r\n                                          \r\n                                          <div class=\"chat-about\">\r\n                                            <div class=\"chat-with\">Chat with {{chatWith.name}}</div>\r\n                                          </div>\r\n                                        </div> <!-- end chat-header -->\r\n                                        \r\n                                        <div class=\"chat-history\">\r\n                                          <ul>\r\n                                            <li *ngFor=\"let msg of allMessages |async|list:chatWith.iduser\" class=\"clearfix\">\r\n                                                <div *ngIf=\"!me(msg.id_user_s)\">\r\n                                                        <div class=\"message-data align-right\">\r\n                                                                <span class=\"message-data-time\" >{{msg.date| date:'MMM dd, HH:mm'}}</span>\r\n                                                                <span class=\"message-data-name\" >{{chatWith.name}}</span> <i class=\"fa fa-circle me\"></i>\r\n                                                                \r\n                                                              </div>\r\n                                                              <div class=\"message other-message float-right\">\r\n                                                                    {{msg.content}}\r\n                                                              </div>\r\n                                                </div>\r\n\r\n                                                <div *ngIf=\"me(msg.id_user_s)\">\r\n                                                        <div class=\"message-data\">\r\n                                                                <span class=\"message-data-name\"><i class=\"fa fa-circle online\"></i>{{user.username}} </span>\r\n                                                                <span class=\"message-data-time\">{{msg.date| date:'MMM dd, HH:mm'}}</span>\r\n                                                              </div>\r\n                                                              <div class=\"message my-message\">\r\n                                                                    {{msg.content}}                                                              </div>\r\n                                                            </div>\r\n                                              \r\n                                            </li>\r\n                                            \r\n                                            <!-- <li>\r\n                                              <div class=\"message-data\">\r\n                                                <span class=\"message-data-name\"><i class=\"fa fa-circle online\"></i> Vincent</span>\r\n                                                <span class=\"message-data-time\">10:12 AM, Today</span>\r\n                                              </div>\r\n                                              <div class=\"message my-message\">\r\n                                                Are we meeting today? Project has been already finished and I have results to show you.\r\n                                              </div>\r\n                                            </li>                                            -->\r\n                                          </ul>\r\n                                          \r\n                                        </div> <!-- end chat-history -->\r\n                                        \r\n                                        <div class=\"chat-message clearfix\">\r\n                                          <textarea #txt name=\"message-to-send\" id=\"message-to-send\" placeholder =\"Type your message\" rows=\"3\"></textarea>\r\n                                          <button (click)=\"send(txt)\">Send</button>\r\n                                  \r\n                                        </div> <!-- end chat-message -->\r\n                                    </div> \r\n                                      </div>\r\n\r\n                        </div>\r\n                    </div>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n    "
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_add_operator_combineLatest__ = __webpack_require__("../../../../rxjs/_esm5/add/operator/combineLatest.js");
...
var ChatComponent = /** @class */ (function () {
    function ChatComponent(authservice, dataService, db, http, activatedRoute) {
    ...
    ChatComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRoute.queryParams.subscribe(function (queryParams) {
            ...
            var url = "http://139.99.107.8/forum-ms-web/v0/user/" + userId;
            _this.dataService.getAll(url).subscribe(function (val) {
                _this.selectuser({
                    iduser: val.idMember,
                    name: val.username,
                    pic: _this.traitPic(val.image)
                });
            });
        });
        var me = this.authservice.currentUser();
        this.MessagesCol = this.db.collection('msg', function (ref) { return ref.where('id_user_d', '==', me.user_id); });
        this.MessagesToMe = this.MessagesCol.valueChanges();
        this.MessagesCol2 = this.db.collection('msg', function (ref) { return ref.where('id_user_s', '==', me.user_id); });
        this.MessagesFromMe = this.MessagesCol2.valueChanges();
        this.allMessages = __WEBPACK_IMPORTED_MODULE_4_rxjs_Rx__["a" /* Observable */].combineLatest([this.MessagesToMe, this.MessagesFromMe])
            .map(function (res) {
            var array = [];
            res[0].forEach(function (v) { return array.push(v); });
            res[1].forEach(function (v1) { return array.push(v1); });
            return array;
        });
    };
            ...
            array.forEach(function (value, index, array) {
                if (value.idMember) {
                    if (user.user_id != value.idMember) {
                        _this.OtherUsers.push({
                            iduser: value.idMember,
                            name: value.username,
                            pic: _this.traitPic(value.image)
                        });
                    }
                }
                else {
                    if (user.user_id != value) {
                        var url = "http://139.99.107.8/forum-ms-web/v0/user/" + value;
    ...
    ChatComponent.prototype.traitPic = function (pic) {
        var path = null;
        if (pic) {
    ...
    ChatComponent.prototype.me = function (id) {
        var user = this.authservice.currentUser();
        return id == user.user_id;
    };
    ChatComponent.prototype.send = function (txt) {
        var msg = txt.value;
        if (msg != "") {
            this.db.collection('msg').add({ 'content': msg,
                'date': Date.now(),
    ...
    ChatComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
            ...
            styles: [__webpack_require__("../../../../../src/app/chat/css/style.css")]
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_services_authentification_service__["a" /* AuthentificationService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_services_authentification_service__["a" /* AuthentificationService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2_services_data_service__["a" /* DataService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_services_data_service__["a" /* DataService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3_angularfire2_firestore__["a" /* AngularFirestore */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_angularfire2_firestore__["a" /* AngularFirestore */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_7__angular_http__["b" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_7__angular_http__["b" /* Http */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_8__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_8__angular_router__["a" /* ActivatedRoute */]) === "function" && _e || Object])
    ], ChatComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_app_chat_chat_routing__ = __webpack_require__("../../../../../src/app/chat/chat.routing.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_app_chat_chat_component__ = __webpack_require__("../../../../../src/app/chat/chat.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_services_list_pipe__ = __webpack_require__("../../../../../src/services/list.pipe.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_services_list2_pipe__ = __webpack_require__("../../../../../src/services/list2.pipe.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_services_authGard1_service__ = __webpack_require__("../../../../../src/services/authGard1.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    ChatModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgModule */])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* RouterModule */].forChild(__WEBPACK_IMPORTED_MODULE_7_app_chat_chat_routing__["a" /* ChatRoutes */]),
                __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormsModule */],
                __WEBPACK_IMPORTED_MODULE_5__angular_http__["c" /* HttpModule */]
            ],
            declarations: [__WEBPACK_IMPORTED_MODULE_10_services_list2_pipe__["a" /* list2Pipe */], __WEBPACK_IMPORTED_MODULE_9_services_list_pipe__["a" /* listPipe */], __WEBPACK_IMPORTED_MODULE_8_app_chat_chat_component__["a" /* ChatComponent */]],
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_11_services_authGard1_service__["a" /* AuthGuard1 */]
            ]
        })
    ], ChatModule);
    return ChatModule;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_app_chat_chat_component__ = __webpack_require__("../../../../../src/app/chat/chat.component.ts");
...
var ChatRoutes = [
    {
        ...
        children: [{
                path: '',
                component: __WEBPACK_IMPORTED_MODULE_0_app_chat_chat_component__["a" /* ChatComponent */],
...
/***/ "../../../../../src/services/list.pipe.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return listPipe; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var listPipe = /** @class */ (function () {
    ...
    listPipe.prototype.transform = function (value, args) {
        if (value) {
...
//# sourceMappingURL=list.pipe.js.map

/***/ }),

/***/ "../../../../../src/services/list2.pipe.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return list2Pipe; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var list2Pipe = /** @class */ (function () {
    function list2Pipe() {
    }
    list2Pipe.prototype.transform = function (value, args) {
        if (args) {
            return value.filter(function (obj) { return obj.name.indexOf(args) !== -1; });
        }
        return value;
    };
    list2Pipe = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["X" /* Pipe */])({
            name: "list2"
        })
    ], list2Pipe);
...
//# sourceMappingURL=list2.pipe.js.map
